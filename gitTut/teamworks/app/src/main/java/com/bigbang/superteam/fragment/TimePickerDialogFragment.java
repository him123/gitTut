    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TimePickerDialog.OnTimeSetListener listener = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                ...
                if (minute % TIME_PICKER_INTERVAL != 0) return;
        ...
        tpd = new TimePickerDialog(getActivity(), listener, mHour, mMinute / TIME_PICKER_INTERVAL, false);

        return tpd;


        /** Opening the TimePickerDialog window */
        // return new TimePickerDialog(getActivity(), listener, mHour, mMinute / TIME_PICKER_INTERVAL, false);
    }
