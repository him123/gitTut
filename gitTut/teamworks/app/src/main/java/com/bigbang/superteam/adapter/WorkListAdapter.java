...
public class WorkListAdapter extends BaseAdapter {
    ...
    public WorkListAdapter(Activity ctx, ArrayList d) {
        mContext = ctx;
        data = d;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        holder.itemTitleTv.setText(data.get(i).getName());
        holder.itemDescriptionTv.setText(data.get(i).getDescription());

        if (data.get(i).getAlertCounter() > 0) {
            holder.alertCounter.setText("" + data.get(i).getAlertCounter());
