package com.bigbang.superteam.stikkyheader.animator;
...
public class HeaderStikkyAnimator extends BaseStickyHeaderAnimator {
    ...
    protected void onAnimatorReady() {
        ...
        hasAnimatorBundles = (mAnimatorBuilder != null)
                && (mAnimatorBuilder.hasAnimatorBundles());
    }
    ...
    public void onScroll(int scrolledY) {
        ...
        if (hasAnimatorBundles) {
            mAnimatorBuilder.animateOnScroll(mBoundedTranslatedRatio,
                    getHeader().getTranslationY());
        }
