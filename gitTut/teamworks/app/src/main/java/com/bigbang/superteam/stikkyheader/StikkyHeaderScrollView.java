...
public class StikkyHeaderScrollView extends StikkyHeader {
	...
	StikkyHeaderScrollView(final Context context, final ScrollView scrollView,
			final View header, final int mMinHeightHeader,
	...
	protected void setHeightHeader(int heightHeader) {
		...
		// creating a placeholder adding a padding to the scrollview behind the
		// header
