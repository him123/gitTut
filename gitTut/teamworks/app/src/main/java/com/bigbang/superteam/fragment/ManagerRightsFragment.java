 ...
 */
public class ManagerRightsFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        ManagerRightsFragment fragment = new ManagerRightsFragment();
        return fragment;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lvPrivileges.setAdapter(new PrivilegesListAdapter(activity, RolesRightsSetupFragment.listPrivilegesM));
    }
