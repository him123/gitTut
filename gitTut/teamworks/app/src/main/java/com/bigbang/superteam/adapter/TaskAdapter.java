...
public class TaskAdapter extends BaseAdapter {
    ...
    private ArrayList<WorkItem> data;
    private Activity mContext;
    private ImageLoader imageLoader;

    public TaskAdapter(Activity ctx, ArrayList<WorkItem> d) {
        mContext = ctx;
        data = d;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.itemTitleTv.setText(data.get(i).getTitle());
        holder.itemDescriptionTv.setText(data.get(i).getDescription());

        /*if (data.get(i).id > 0) {
            holder.alertCounter.setText("" + data.get(i).);
        ...
        String localEndTime = Util.utcToLocalTime(data.get(i).getEndDate());
