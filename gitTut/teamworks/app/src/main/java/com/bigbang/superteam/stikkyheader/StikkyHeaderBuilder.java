package com.bigbang.superteam.stikkyheader;
...
import com.bigbang.superteam.stikkyheader.animator.HeaderStikkyAnimator;
...
public abstract class StikkyHeaderBuilder {
    ...
    public StikkyHeaderBuilder minHeightHeaderDim(
            @DimenRes final int resDimension) {
    ...
    public static class ListViewBuilder extends StikkyHeaderBuilder {
        ...
        @Override
        public com.bigbang.superteam.stikkyheader.StikkyHeaderListView build() {
            ...
            return new com.bigbang.superteam.stikkyheader.StikkyHeaderListView(mContext, mListView, mHeader,
    ...
    public static class RecyclerViewBuilder extends StikkyHeaderBuilder {
        ...
        @Override
        public com.bigbang.superteam.stikkyheader.StikkyHeaderRecyclerView build() {
            ...
            return new com.bigbang.superteam.stikkyheader.StikkyHeaderRecyclerView(mContext, mRecyclerView,
    ...
    public static class ScrollViewBuilder extends StikkyHeaderBuilder {
        ...
        @Override
        public com.bigbang.superteam.stikkyheader.StikkyHeaderScrollView build() {
            ...
            return new com.bigbang.superteam.stikkyheader.StikkyHeaderScrollView(mContext, mScrollView, mHeader,
                    mMinHeight, mAnimator);
        }
