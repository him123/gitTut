 ...
 */
public class LocationServiceGF extends Service
...
//        Util.appendLog("Location Service onConnected()");
    ...
    public void onCreate() {
        int permissionCheck = ContextCompat.checkSelfPermission(LocationServiceGF.this, Manifest.permission.ACCESS_FINE_LOCATION);
