 ...
 */
public class ExpenseAdminEveryoneFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        ExpenseAdminEveryoneFragment fragment = new ExpenseAdminEveryoneFragment();
        return fragment;
    }
    ...
    private void getUserExpenses() {
        ...
        if (Util.isOnline(getActivity())) {
            ...
            RestClient.getCommonService().getMemberExpenses(Util.ReadSharePrefrence(getActivity(), Constant.SHRED_PR.KEY_USERID),
                            ...
                            try {
                                ...
                                if (isSuccess) {
                                    if (list != null && list.size() > 0) {
                                        ...
                                        //set in adapter
                                        adapter = new ExpenseListAdapter(getActivity(), list, true);
